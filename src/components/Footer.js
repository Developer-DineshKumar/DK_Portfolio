    ...
    <div className="footer">
        <div className="footer-container">
            ...
            <div className="details-right">
                <a className="linkedin" href="https://www.linkedin.com/in/dinesh-kumar-nadakuduru-262270148/" target="_blank" rel="noreferrer">
                <FaLinkedin size={32} style={{color:"#0A66C2",marginRight:"2rem" }}/>
                <h4 style={{color:"#0A66C2"}}>Linkedin</h4>
                </a>
            
                             
                <a className="github" href="https://github.com/Developer-DineshKumar" target="_blank" rel="noreferrer">
