...
const ProjectCardData = [
    ...
    },
    {
        imgsrc:img4,
        title:"Book Hub",
        text:"Implemented a Book Hub app that fetches data from an internal server using a class component, displaying that data, using component lifecycle methods, routing concepts, authentication, and authorization, and adding responsiveness to the website. Technologies used: React.js",
